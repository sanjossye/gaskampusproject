...
import 'driver_trip_complete_screen.dart';
...
class _DriverActiveTripScreenState extends State<DriverActiveTripScreen> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.network(
              'https://lh3.googleusercontent.com/aida-public/AB6AXuCdQCmUS8d53o3aPDIaVt4CmoP18yK9fUd06cyuHdA3jnK1GtTumSXp92mO30TsxXLM-rO8IT4G5cl8XWa52PiptzGFXifKgFsvCHYeGnptEE8YdIDulBJQ8YDNSBRUb8wYyS3tTkHg2fShnkP92rJKXMud__Yl297Bjop9wZYlMZ3GGKG0lWdISe2dSewFr7T7yC8CHusx-7646RHv8Z5vT3Tl6Uiz51RwJebgw30Ug38cYDg0chdv0dD94LBSDswcVFyPc7s0M_8',
              fit: BoxFit.cover,
            ),
          ),

          // Optional: A custom painter for the route line could be added here
          // For now, we will just position the dots based on the HTML
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: const DecorationImage(
                                      image: NetworkImage(
                                          'https://lh3.googleusercontent.com/aida-public/AB6AXuBT3DG2FDx8eV1U2yGwNVJNT_P1uq-CaczYd3H8ZZspxNr4XFNkTLx3JQ_04MtkeR58bRUb0ML3MjjUz2vuV2ppU22PYKt9x82sFCWkiQRWMcpzvftW5ZGrr1b3GmoGosdavmpfBhOZ-YXEkRSPEuLsbFE_VAelw8O-C5oTTtaHS-SZR11is67x6OGKoXc69ztbskLJKfellPWCGVKKvWKM2dm86Z6lXpEGeaGoVY16uTjxzI7-WqSZojVCFBCKCyHh7HtItCZcJa4'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                  ...
                                  RichText(
                                    ...
                                    text: const TextSpan(
                                      ...
                                      children: [
                                        ...
                                        TextSpan(text: 'Gedung Perpustakaan Pusat'),
                                      ],
                                    ),
                                  ),
                                ],
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => const DriverTripCompleteScreen()),
                        );
                      },
